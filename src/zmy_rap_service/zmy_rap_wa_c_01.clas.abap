CLASS zmy_rap_wa_c_01 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
   ...
   INTERFACES if_rap_query_provider.
    ...
    TYPES t_agency_range  TYPE RANGE OF ty_travel-agency_id.
    TYPES t_business_data TYPE TABLE OF ty_travel.
...
CLASS zmy_rap_wa_c_01 IMPLEMENTATION.
 METHOD if_oo_adt_classrun~main.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZMY_RAP_TRAVEL_SC_01' ).
